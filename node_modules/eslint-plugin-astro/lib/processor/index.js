...
exports.clientSideTsProcessor = exports.astroProcessor = void 0;
const astro_eslint_parser_1 = require("astro-eslint-parser");
const shared_1 = require("../shared");
const meta = __importStar(require("../meta"));
exports.astroProcessor = {
...
exports.clientSideTsProcessor = {
    preprocess(code, filename) {
        return preprocess(code, filename, ".ts");
    },
    postprocess,
    supportsAutofix: true,
    meta: Object.assign(Object.assign({}, meta), { name: "astro/client-side-ts" }),
};
function preprocess(code, filename, vartualFileExt) {
    if (filename) {
