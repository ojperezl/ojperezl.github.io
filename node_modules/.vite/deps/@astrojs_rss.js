...
// node_modules/@astrojs/rss/dist/index.js
var rssFeedItemValidator = rssSchema.extend({ link: z2.string(), content: z2.string().optional() });
var globResultValidator = z2.record(z2.function().returns(z2.promise(z2.any())));
var rssOptionsValidator = z2.object({
  title: z2.string(),
  description: z2.string(),
  site: z2.preprocess((url) => url instanceof URL ? url.href : url, z2.string().url()),
  items: z2.array(rssFeedItemValidator).or(globResultValidator).transform((items) => {
  ...
  xmlns: z2.record(z2.string()).optional(),
  stylesheet: z2.union([z2.string(), z2.boolean()]).optional(),
  customData: z2.string().optional(),
  trailingSlash: z2.boolean().default(true)
});
...
async function generateRSS(rssOptions) {
  ...
  const parser = new import_fast_xml_parser.XMLParser(xmlOptions);
  ...
  return new import_fast_xml_parser.XMLBuilder(xmlOptions).build(root);
}
export {
...
//# sourceMappingURL=@astrojs_rss.js.map
